...
int query_disks_info(char *diskName,char *dirId);			//查询硬盘内目录信息
int query_disks_primary_info(char *diskName,char *dirId);			//查询硬盘内目录基本信息
int query_disks_all_info(char *diskName,char *dirId);			//查询硬盘内目录详细信息

/***************************************************************************/
/************************* 目录操作函数声明区 *********************************/
/***************************************************************************/
//char* get_directory_id(char *dirName, char *diskName);	//获取目录ID
char* get_directory_id(char* diskName,char* dirName,char* parentId);//获取目录ID
char* get_parent_id(char *dirId);      //获取父目录ID
char* get_directory_name(char *dirId);  //获取目录名
db_directory_info* get_directory_info(char *diskName, char *dirName, char *parentId);		//获取db_directory_info
...
int query_directory_info(char *diskName, char *dirId);	//查询目录内文件和目录信息
int query_directory_primary_info(char *diskName, char *dirId);	//查询目录内文件和目录基本信息
int query_directory_all_info(char *diskName, char *dirId);	//查询目录内文件和目录详细信息
...
int get_file_primary_info(char *diskName, char *dirId, char *fileName);	//获取指定文件基本信息
int get_file_all_info(char* diskName,char* dirId, char* fileName);	//获取指定文件详细信息
...
int query_file_by_time_curr(char *diskName, char *dirId,char *start_time, char * end_time);//根据时间查询文件信息
int query_file_by_location(char *start_ra, char *end_ra, char *start_dec, char *end_dec);		//根据位置查询文件信息
int query_file_by_curr_location(char* diskName,char* dirId,char *start_ra, char *end_ra, char *start_dec, char *end_dec);		//根据位置查询文件信息
